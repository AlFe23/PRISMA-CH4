...
def main():
    ...
    #image_tarball_path = input("Enter the path to the Docker image tarball file: ")
    image_tarball_path = '/mnt/c/Users/ferra/Documents/codici/CH4/CTMF/ctmf/ctmf_v1.0.tar'
    
    # Load the Docker image from the tarball
    load_docker_image(image_tarball_path)
    

    docker_command =    """docker run -v /mnt/d/CLEAR_UP/CH4_detection:/app/data ctmf \
                        ...
                        "/app/data/img_PRISMA/USA/Encinal_wells_USA/20200426/MF_out" --clusters 30"""
